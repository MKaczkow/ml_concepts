...
# TODO
- [ ] re-organize / cleanup the structure
...
Here is that content organized into a hierarchical markdown structure, with the sub-items alphabetized and typos corrected for clarity.

## Contents
* [Ideas](./ideas/)
    * [Grammar Constrained Decoding](./ideas/grammar_constrained_decoding/)
    * [GPT From Scratch](./ideas/gpt_from_scratch/)
    * [Graph Neural Networks](./ideas/graph_neural_networks)
    * [LSTM](./ideas/lstm)
    * [Metric Learning](./ideas/metric_learning)
    * [Seq2Seq](./ideas/seq2seq)
    * [SSL](./ideas/ssl)
    * [Transformers](./ideas/transformer_from_scratch)
    * [VAE](./ideas/vae)
    * [XAI](./ideas/xai)
    * [XGBoost](./ideas/xgboost)
* [Tasks](./tasks/)
...
* [Theory](./theory/)
    ...
    * [Byte-Pair Encoding Tokenizer](./theory/bpe_tokenizer/)
    * [Cross Entropy](./theory/cross_entropy)
    * [Einsum](./theory/einsum)
    * [Kernels](./theory/kernels/)
    * [Kullback-Leibler Divergence](./theory/kulback_leibler_divergence)
